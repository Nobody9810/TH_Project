...
//     >
//       <div
//         className="max-w-6xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-300 scale-100 max-h-[90vh] overflow-y-auto"
//         onClick={(e) => e.stopPropagation()}
//       >
//         {/* 头部 */}
//         <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white sticky top-0 z-10">
...
//                           {vid.title && <p className="font-semibold text-lg mb-1">{vid.title}</p>}
//                           {vid.description && <p className="text-sm text-gray-300">{vid.description}</p>}
//                         </div>
//                       )}
//                     </div>
//                   </SwiperSlide>
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              <span className={`px-3 py-1 text-xs font-bold rounded-full ${
                material.material_type === 'hotel' ? 'bg-blue-100 text-blue-700' :
